                            ...
                            >
                                <div class="card card-product mb-lg-4">
                                    <div class="card-body text-center py-8">
                                        <img
                                            src="https://ng.jumia.is/unsafe/fit-in/300x300/filters:fill(white)/product/19/8636501/1.jpg?2920"
                        ...
                        <div class="col">
                            <div class="card card-product">
                                <div class="card-body">
                                    ...
                                    <h2 class="fs-6"><a
                                            href="pages/shop-single.php"
                                            class="text-inherit text-decoration-none"
                                        >Haldiram's Sev Bhujia</a></h2>
                                    <div>
                            ...
                            <div class="card card-product">
                                <div class="card-body">
                                    <div class="text-center position-relative">
                                        ...
                                        <a href="pages/shop-single.php"><img
                            ...
                            <div class="card card-product">
                                <div class="card-body">
                                    ...
                                    <h2 class="fs-6"><a
                                            href="pages/shop-single.php"
                                            class="text-inherit text-decoration-none"
                                        >Kellogg's Original Cereals</a></h2>
                                    <div class="text-warning">
                                        <small>
                                            <i class="bi bi-star-fill"></i>
                                            <i class="bi bi-star-fill"></i>
